...
import com.ametrin.fancy_food.world.food.FFFoods;
...
public final class FFItems {
    ...
    public static final DeferredItem<Item> CARROT_SALAD = REGISTER.registerSimpleItem("carrot_salad", new Item.Properties().food(FFFoods.CARROT_SALAD));
}
